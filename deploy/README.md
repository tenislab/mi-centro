...
sw.js                     ← funcionamiento sin conexión (no borrar)
...
## Instalarla en el móvil o el ordenador

Una vez publicada en GitHub Pages (hace falta https, no funciona abriendo el archivo desde el disco):

- **Android / Chrome / Edge**: aparece el botón **Instalar** en la barra superior, o Configuración → Instalar ahora.
- **iPhone / Safari**: botón Compartir → *Añadir a pantalla de inicio*.
- **Ordenador**: icono de instalar en la barra de direcciones.

Instalada se abre a pantalla completa desde su icono y **funciona sin conexión** — los datos ya están en el dispositivo. Cuando publiques una versión nueva, se actualiza al abrirla con conexión.
